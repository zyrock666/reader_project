...
void spi1_init(void)
{
    ...
    g_spi1_handler.Init.BaudRatePrescaler = SPI_BAUDRATEPRESCALER_32;   /* 定义波特率预分频的值:波特率预分频值为2 */
...
void HAL_SPI_MspInit(SPI_HandleTypeDef *hspi)
{
    ...
    if (hspi->Instance == SPI1_SPI)
    {
        ...
        SPI1_SCK_GPIO_CLK_ENABLE();  /* SPI2_SCK脚时钟使能 */
        SPI1_MISO_GPIO_CLK_ENABLE(); /* SPI2_MISO脚时钟使能 */
        SPI1_MOSI_GPIO_CLK_ENABLE(); /* SPI2_MOSI脚时钟使能 */
